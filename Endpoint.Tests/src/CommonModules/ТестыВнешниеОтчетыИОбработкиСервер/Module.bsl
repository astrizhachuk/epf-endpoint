...
// @unit-test
Процедура ПолучитьЗагружатьФайлыИзВнешнегоХранилищаВключено(Фреймворк) Экспорт
	
	// given
	Константы.ЗагружатьФайлыИзВнешнегоХранилища.Установить(Истина);

	// when
	Результат = ВнешниеОтчетыИОбработки.ПолучитьЗагружатьФайлыИзВнешнегоХранилища();
...
// @unit-test
Процедура ПолучитьЗагружатьФайлыИзВнешнегоХранилищаОтключено(Фреймворк) Экспорт
